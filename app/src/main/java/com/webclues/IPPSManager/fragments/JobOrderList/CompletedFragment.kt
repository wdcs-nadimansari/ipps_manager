...
class CompletedFragment : Fragment() {
    ...
    private val mReceiver = object : BroadcastReceiver() {   //Setpriority data in Completed
...
//            isloading = false
    ...
    fun loadFirstpage(        //load first page data in Completed
...
//        jobOrderAdapter!!.jobstatuslist!!.clear()
    ...
    private fun loadNextPage(         //load next page data in completed
        pagenumber: Int,
        jobstatus: Int,
        filterpriority: Int,
        engineerid: String
