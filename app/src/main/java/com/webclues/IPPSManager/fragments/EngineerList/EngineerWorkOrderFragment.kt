 ...
 */
class EngineerWorkOrderFragment : Fragment() {
    ...
    private val mReceiver =
        object : BroadcastReceiver() {    //Setpriority data in EngineerWorkorder
...
//        priority = Content.ALL
    ...
    fun loadFirstpage(               //load first page data in EngineerWorkorder
    ...
    private fun loadNextPage(            //load nextpage data in EngineerWorkorder
        pagenumber: Int,
        jobstatus: Int,
        filterpriority: Int,
        engineerid: String
