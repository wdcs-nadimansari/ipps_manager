...
class KivFragment : Fragment() {
    ...
    private val mReceiver = object : BroadcastReceiver() {  //Set Priority data in Kiv
...
//            isloading = false
    ...
    fun initView(view: View) {
        ...
        Content.JOBTYPE = Content.KIV_STATUS
        ...
        rvJobs.addOnScrollListener(object :
            ...
            override fun loadMoreItems() {
                isloading = true
                currentpage += 1
                loadNextPage(currentpage, Content.KIV, Content.FILTER_PRIORITY, "")
            }
    ...
    fun loadFirstpage(             //load first page in Kiv
        ...
        val call: Call<JsonObject> =
            apiInterface.jobstatus(currentpage, Content.KIV, Content.FILTER_PRIORITY, "")
    ...
    private fun loadNextPage(           //load next page in Kiv
        pagenumber: Int,
        jobstatus: Int,
        filterpriority: Int,
        engineerid: String
